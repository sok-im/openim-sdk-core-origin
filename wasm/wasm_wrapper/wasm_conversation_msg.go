...
func (w *WrapperConMsg) MarkGroupMsgsAsRead(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.MarkGroupMsgsAsRead, callback, &args).AsyncCallWithCallback()
}
...
func (w *WrapperConMsg) ReportSpam(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
...
func (w *WrapperConMsg) DeleteMessageWithOptions(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(open_im_sdk.DeleteMessageWithOptions, callback, &args).AsyncCallWithCallback()
}
...
func (w *WrapperConMsg) SetConversationMute(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
