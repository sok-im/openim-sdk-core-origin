...
var (
	...
	SetDeleteAccountInterval            = newApi[user.SetDeleteAccountIntervalReq, user.SetDeleteAccountIntervalResp]("/user/set_delete_account_interval")
	...
	SetMsgNotificationSwitch            = newApi[user.SetMsgNotificationSwitchReq, user.SetMsgNotificationSwitchResp]("/user/set_msg_notification_switch")
	SetSokimPaymentNotificationSwitch   = newApi[user.SetSokimPaymentNotificationSwitchReq, user.SetSokimPaymentNotificationSwitchResp]("/user/set_sokim_payment_notification_switch")
	SetSokimServiceNotificationSwitch   = newApi[user.SetSokimServiceNotificationSwitchReq, user.SetSokimServiceNotificationSwitchResp]("/user/set_sokim_service_notification_switch")
	SetAvNotificationSwitch             = newApi[user.SetAvNotificationSwitchReq, user.SetAvNotificationSwitchResp]("/user/set_av_notification_switch")
	SetAvCallRingtoneSwitch             = newApi[user.SetAvCallRingtoneSwitchReq, user.SetAvCallRingtoneSwitchResp]("/user/set_av_call_ringtone_switch")
	SetPlayCalleeRingtoneOnAnswerSwitch = newApi[user.SetPlayCalleeRingtoneOnAnswerSwitchReq, user.SetPlayCalleeRingtoneOnAnswerSwitchResp]("/user/set_play_callee_ringtone_on_answer_switch")
	GetUserNotificationSettings         = newApi[user.GetUserNotificationSettingsReq, user.GetUserNotificationSettingsResp]("/user/get_user_notification_settings")
...
var (
	...
	SetFriendNote                = newApi[relation.SetFriendNoteReq, relation.SetFriendNoteResp]("/friend/set_note")
