...
func registerFunc() {
	...
	js.Global().Set("setMessageReaction", js.FuncOf(wrapperConMsg.SetMessageReaction))
	...
	js.Global().Set("signalingIsCallEndedByRoomID", js.FuncOf(wrapperSignaling.SignalingIsCallEndedByRoomID))
